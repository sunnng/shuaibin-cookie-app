...
import { Skeleton } from "@shuaibin-cookie-app/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@shuaibin-cookie-app/ui/components/tooltip";
...
function SidebarProvider({
	...
	const setOpen = useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: persisted sidebar state via generated shadcn pattern
